        ...
        <div className="min-h-screen bg-[#10182B]">
            <div className="container mx-auto px-4 py-6 md:py-10">
                ...
                <motion.div
                    ...
                    className="relative overflow-hidden bg-gradient-to-r from-[#1C2740] via-[#10182B] to-[#1C2740] border border-[#A78BFA]/20 rounded-2xl md:rounded-3xl py-10 md:py-16 px-6 md:px-8 text-center shadow-xl mb-6 md:mb-10"
                >
                ...
                >
                    <div className="grid grid-cols-7 gap-4">
                        ...
                        <select
                            value={currentLevel}
                            onChange={(e) =>
                                updateQueryParams("level", e.target.value)
                            }
                            className="bg-[#10182B] border border-[#A78BFA]/30 rounded-xl px-4 py-3 outline-none focus:border-[#A78BFA] text-[#EDEFF5] transition-colors"
                        >
                            {LEVELS.map((level) => (
                ...
                <div className="lg:hidden mb-4">
                    <div className="flex gap-3">
                        ...
                        <Button
                            ...
                            className="bg-[#1C2740] border border-[#A78BFA]/30 text-[#EDEFF5] min-w-[52px] h-[52px] rounded-xl hover:bg-[#A78BFA]/10"
                        >
                    ...
                    >
                        <div className="bg-[#1C2740] border border-[#A78BFA]/20 rounded-2xl p-4 space-y-3">
                            {/* Category */}
                            <div>
                                <label className="text-[#EDEFF5]/60 text-xs font-medium block mb-1.5">
                                    Category
                                </label>
                                <select
                                    value={currentCategory}
                ...
                {totalCourses === 0 ? (
                    <Card className="bg-[#1C2740] border border-[#A78BFA]/20 rounded-3xl shadow-xl py-20 text-center">
                        ...
                        <h2 className="text-3xl font-bold text-[#EDEFF5]">
                            No courses found
                        </h2>
                        <p className="text-[#EDEFF5]/50 mt-3">
                                ...
                                {Array.from(
                                    ...
                                    (_, index) => {
                                        ...
                                        if (
                                            ...
                                            (index === 6 && pageNumber < totalPages)
                                        ) {
                                            return (
                                                <span key={`ellipsis-${index}`} className="text-[#EDEFF5]/40">
                                                    ...
                                                </span>
                                            );
                                        }
